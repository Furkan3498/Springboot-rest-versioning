package versioning.with.spring.boot.and.rest.api.Controller;
...
import versioning.with.spring.boot.and.rest.api.DTO.ProductV1;
import versioning.with.spring.boot.and.rest.api.DTO.ProductV2;
...
public class ProductApi {
    ...
    public ResponseEntity <ProductV1> pathVersioningProductV1(){
        return ResponseEntity.of((Optional.of( new ProductV1("Iphone"))));
    }
    //http://localhost:8080/api/v1/product
    @GetMapping(value = "/v2/product")
    public ResponseEntity<ProductV2> pathVersioningProductV2() {
       return ResponseEntity.of(Optional.of(new ProductV2("Iphone", BigDecimal.TEN)));
    }
    //PARAM Versioning
